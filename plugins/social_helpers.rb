module SocialHelpers
  ...
  #
  def og_image(mode: "light", color: "007aff", pattern: "diagonal_lines", url: "ziku.dev/")
  ...
  def twitter_share_url(resource)
    ...
    "https://mobile.twitter.com/intent/tweet/?text=#{title}%20by%20@zilkucinskas%20#{url}"
  end
...
Bridgetown::RubyTemplateView::Helpers.include SocialHelpers
